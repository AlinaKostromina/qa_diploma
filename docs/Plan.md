...
_Сценарий 39_  
_Отправить заявку на покупку тура с невалидным заполнением полей (китайский) дебетовая карта._
1. Зайти на сайт http://localhost:8080/
1. Кликнуть на поле "Купить".
1. Заполнить данные карты тестовыми данными:
   * номер карты: 4444 4444 4444 4441
...
_Сценарий 40_  
_Отправить заявку на покупку тура с невалидным заполнением полей (китайский) кредитная карта._
1. Зайти на сайт http://localhost:8080/
1. Кликнуть на поле "Купить в кредит".
1. Заполнить данные карты тестовыми данными:
   * номер карты: 4444 4444 4444 4441
